...
The project demonstrates actuarial reserving, claims analysis, data cleaning, and chain-ladder modelling used in general insurance actuarial work.

Business Problem:

A portfolio manager identified concerns that motor insurance claims were developing more slowly than expected, which could result in outstanding claims being underestimated.
